# Week 10 Summary - Final Refinement
...
| F8 | NN+GP | UCB | Beta=1.5 | 9.2 | 0.7 | Ensemble |
...
- **F8**: Ensemble showing steady progress
...
- Preserve stable peaks and look for one last controlled gain in the unresolved functions.
